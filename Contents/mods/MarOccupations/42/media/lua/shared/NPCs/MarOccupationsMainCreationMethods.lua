...
local function addMarOccupationsProfessions()
	...
	local profFederalAgent = MarLibrary.Traits.addProfession("mar_federalagent", -14)
	profFederalAgent:addXPBoost(Perks.Aiming, 3)
	profFederalAgent:addXPBoost(Perks.Reloading, 2)
	profFederalAgent:addXPBoost(Perks.Fitness, 1)
	profFederalAgent:addXPBoost(Perks.Nimble, 1)
	profFederalAgent:addFreeTrait(MarLibrary.Traits.addTraitCopy("Brave", 0, "brave", "bravedesc"))
	--profFederalAgent:addFreeTrait("Mar_DefenseTactics")
